export default function Footer() {
  return (
    <div>
      <div className="flex flex-col items-center p-2 pb-6 transition-colors duration-300" style={{ backgroundColor: '#120A68' }}>
        <div className="flex flex-col lg:flex-row justify-between items-center w-full max-w-screen-lg p-3">
          ...
          <div className="text-center lg:text-left w-full lg:w-1/2 flex flex-col items-center">
            <div className="text-white font-bold text-4xl mb-4">E-Club Polimi</div>
          </div>

          {/* Contact Section */}
          <div className="flex flex-col items-center w-full lg:w-1/2 mt-6 lg:mt-0">
            <h2 className="text-white text-lg font-semibold text-center lg:text-left mb-4">
              Contact Us
            </h2>
        ...
        <div className="text-white text-xs mt-9 text-center">
          Copyright © {new Date().getFullYear()} E-Club Polimi. All rights reserved.
        </div>
      </div>
    </div>
  );
