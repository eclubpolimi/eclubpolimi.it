...
export declare const SliderWrapper: React.ForwardRefExoticComponent<SliderConfig & {
    className?: string;
...
export declare const SliderNav: React.ForwardRefExoticComponent<SliderNavProps & React.RefAttributes<HTMLDivElement>>;
export {};
