export type PIALesson = {
  name: string;
  title: string;
  imageKey: string; // Changed from 'image' to 'imageKey' to reference Contentful assets
  alt: string;
  description: string;
};
...
const pialessons: PIALesson[] = [
  {
    name: 'Lesson 1',
    title: 'Lean approach',
    imageKey: 'pia_lessons_lean_thinking', // Reference to Contentful asset
  ...
  },
  {
    name: 'Lesson 2',
    title: 'Pitching',
    imageKey: 'pia_lessons_elevator_pitch', // Reference to Contentful asset
    alt: 'Pitching image',
    description:
  ...
  },
  {
    name: 'Lesson 3',
    title: 'Finance',
    imageKey: 'pia_lessons_finance_basics', // Reference to Contentful asset
    alt: 'Finance image',
    description:
  ...
  },
  {
    ...
    imageKey: 'pia_lessons_idea_protection', // Reference to Contentful asset
