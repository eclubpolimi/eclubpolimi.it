...
export const SliderNav = React.forwardRef(function SliderNav({ className = '', ...props }, ref) {
    ...
    return (React.createElement("div", { ...props, onFocus: (e) => {
        ...
        }, onMouseLeave: (e) => e.stopPropagation(), className: cj(className, `w-slider-nav ${navInvert ? 'w-slider-nav-invert' : ''} ${navShadow ? 'w-shadow' : ''} ${navRound ? 'w-round' : ''} ${navNumbers ? 'w-num' : ''}`), ref: ref }, dots));
});
