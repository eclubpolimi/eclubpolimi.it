...
const BgVideoContext = React.createContext({ isPlaying: true, togglePlay: () => undefined });
export const BackgroundVideoWrapper = React.forwardRef(function BackgroundVideoWrapper({ tag = 'div', className = '', autoPlay = true, loop = true, sources = [], posterImage = '', children, }, ref) {
