...
export declare const Subscript: React.ForwardRefExoticComponent<import("./Basic").ElementProps<"sub"> & {
    children?: React.ReactNode | undefined;
} & React.RefAttributes<HTMLElement>>;
export declare const Superscript: React.ForwardRefExoticComponent<import("./Basic").ElementProps<"sup"> & {
    children?: React.ReactNode | undefined;
} & React.RefAttributes<HTMLElement>>;
export declare const RichText: React.ForwardRefExoticComponent<import("./Basic").ElementProps<"div"> & {
