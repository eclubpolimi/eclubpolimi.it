...
const values = [
  {
    ...
    accentSoft: '#FFE8DC',
    description:
      'We host impactful events, hands-on workshops, and speaker sessions with founders and industry leaders to grow your skills.',
    icon: (
      <svg
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    accentSoft: '#EBEAFE',
    description:
      'Join a diverse, collaborative community. Find co-founders, mentors, and peers to spark new ideas and ventures.',
    icon: (
      <svg
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    accentSoft: '#FFE8DC',
    description:
      'Turn ideas into reality with support from our network. Prototype, launch, and iterate on projects that create impact.',
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="w-12 h-12 text-[#FF6B35]"
