...
const Lesson = ({ lessonData, className = '' }: LessonProps) => {
  ...
  return (
    <div
      className={`${className} bg-ec_background dark:bg-ec_background_darkmode transition-colors duration-300 p-6 rounded-lg shadow-md`}
    >
      <div className="flex flex-col lg:flex-row justify-center w-full h-full">
        ...
        <div className="w-100 pt-5 pl-0 lg:w-1/2 lg:pl-5 text-justify leading-6 text-ec_text dark:text-ec_text_darkmode transition-colors duration-300">
