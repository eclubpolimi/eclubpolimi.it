  ...
  return (
    <footer className="bg-gradient-to-br from-[#2B5DAA] to-[#1e3a5f] text-white px-5 md:px-20">
      ...
      <div className="border-t border-white/10 py-6">
        <div className="w-full max-w-screen-xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-xs text-white/80">
          <div>Copyright © {new Date().getFullYear()} E-Club Polimi. All rights reserved.</div>
