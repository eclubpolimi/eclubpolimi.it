...
const OutlineLabel = ({
  ...
  return (
    <div
      ...
      ${
        invertedColors
          ? 'bg-ec_orange dark:bg-ec_orange_darkmode transition-colors duration-300 after:border-ec_blue dark:after:border-ec_blue_darkmode'
          : 'bg-ec_blue dark:bg-ec_blue_darkmode transition-colors duration-300 after:border-ec_orange dark:after:border-ec_orange_darkmode'
      }
