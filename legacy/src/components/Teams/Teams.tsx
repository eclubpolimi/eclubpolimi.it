...
const Teams = ({ teams, className }: TeamsProps) => {
  return (
    <div className={`py-10 ${className}`}>
      <h2 className="md:text-center mb-5 text-ec_text dark:text-ec_text_darkmode transition-colors duration-300">
        E-Club Teams
      </h2>
        ...
        {teams.map((team: TeamProps) => (
          <div key={team.teamName} className="team-section">
            <div className="flex items-center">
              <div className="w-full h-[4px] bg-ec_blue dark:bg-ec_blue_darkmode transition-colors duration-300"></div>
              <div className="px-4 py-2 bg-ec_blue dark:bg-ec_blue_darkmode transition-colors duration-300 text-white font-bold text-2xl rounded-lg mx-4 text-center sm:whitespace-nowrap whitespace-normal sm:inline-block w-auto">
                {team.teamName}
              </div>
              <div className="w-full h-[4px] bg-ec_blue dark:bg-ec_blue_darkmode transition-colors duration-300"></div>
            </div>
