...
const JoinUsCard = ({
  ...
  return (
    <div
      className={`bg-ec_background_light dark:bg-transparent transition-colors duration-300 
    ...
    >
      <div className="mx-5 flex-grow flex flex-col">
        <h2 className="md:text-center text-ec_text dark:text-ec_text_darkmode transition-colors duration-300 mb-4 text-lg">
          {role}
        </h2>
          ...
          <ul className="list-disc w-full">
            {Array.isArray(advantages) ? (
              advantages.map((pro, index) => (
                <li
                  className="my-2 text-base text-ec_text_secondary dark:text-ec_text_secondary_darkmode transition-colors duration-300"
                  key={index}
                >
                  {pro}
                </li>
              ...
              <li className="my-2 text-base text-ec_text_secondary dark:text-ec_text_secondary_darkmode transition-colors duration-300">
